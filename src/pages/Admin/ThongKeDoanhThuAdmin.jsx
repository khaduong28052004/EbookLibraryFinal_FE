...
import TableThongKe from './components/Table_ThongKe_DoanhThu';
...
const DoanhThuAdmin = () => {
  ...
  const findAllDoanhThu = async () => {
    try {
      const response = await Thongke.doanhThu({ dateStart, dateEnd, currentPage, size: 10, searchItem, sortColumn, sortBy });
  ...
  const handleChange = (dateStart, dateEnd, searchItem, page, sortBy, sortColumn) => {
