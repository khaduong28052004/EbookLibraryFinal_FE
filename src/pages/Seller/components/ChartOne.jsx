    ...
    if (data && Array.isArray(data.listDoanhSo) && Array.isArray(data.listDoanhThu)) {
      ...
      setState({
        series: [
          {
            name: 'Doanh Số',
            data: data.listDoanhSo.map(item => Math.round(item.value)),
          },
          {
            name: 'Doanh Thu',
            data: data.listDoanhThu.map(item => Math.round(item.value)),
          },
        ],
        totalDoanhSo: totalDoanhSo,  // Cập nhật tổng doanh số
        totalDoanhThu: totalDoanhThu, // Cập nhật tổng doanh thu
      });
