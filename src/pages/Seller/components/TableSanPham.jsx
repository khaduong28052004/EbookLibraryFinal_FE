...
try {
  const response = await predictTextModeration(text);
  console.log("CHECK TEXT", response)
} catch (error) {
  console.log("ERROR CHECK TEXT", error);
}
  }
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  ...
                  <div className="w-full xl:w-1/3">
                    ...
                    <input
                      ...
                      onChange={(e) => {handleCheckText(e.target.value)}}
