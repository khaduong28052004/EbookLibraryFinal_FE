...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    loadDATA(2, idaccount, setIndex1); // Load data for index1
    loadDATA(3, idaccount, setIndex2); // Load data for index2
    loadDATA(4, idaccount, setIndex3); // Load data for index3
    fetchData(idaccount);
  }, []);
    ...
    <>
      ...
      <div className="dashboard-info mt-8 bg-primarygray px-7 py-7 rounded-lg shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-1">
          ...
          <div>
            <p className="title text-xl font-semibold text-gray-800 mb-5">Thông tin cá nhân</p>
            <div className="space-y-4">
              ...
              <div className="flex justify-between ">
                ...
                <div>                <span className="value text-base font-semibold text-gray-900 flex justify-end">{formData.email || "N/A"}</span>
</div>
              </div>
              <div className="flex justify-between">
          ...
          {/* Store Info Section */}
          {/* <div>
            <p className="title text-xl font-semibold text-gray-800 mb-5">Thông tin cửa hàng</p>
            <div className="space-y-4">
              {user.roles === "SELLER" ? (
                <>
                  <div className="flex justify-between">
                ...
                <div className="text-center mt-4">
                  <Link to='/become-saller' className="text-[#003EA1] font-medium text-lg hover:underline">
